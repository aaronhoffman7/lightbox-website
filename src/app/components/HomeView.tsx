...
export default function HomeView() {
  ...
  // modal state for site assessment popup
  ...
  return (
    <main>
            ...
            <div className="services-grid">
              <div className="service-card">
                ...
                <p>
                  ...
                  prepare your roofs, land, or parking areas for solar, batteries, and electric
                  vehicle charging. Our make-ready assessments and designs optimize site
                  electrical capacity and routing for long term resiliency and scalability.
                </p>
              </div>
              ...
              <div className="service-card">
                ...
                <p>
                  We use data-driven insights to optimize building performance, integrating
                  battery storage, load shifting, and peak demand strategies to lower costs
                  and emissions. We&apos;ll help you take advantage of every applicable rebate,
                  production incentive, and tax credit during your energy upgrade.
                </p>
              </div>
              ...
              <div className="service-card">
                ...
                <p>
                  We oversee solar, storage, and EV charger projects from deal structuring
                  and RFP development through engineering, construction and commissioning –
                  prioritizing safety, performance, and compliance.
                </p>
              </div>
              ...
              <div className="service-card">
                ...
                <p>
                  Our technicians provide proactive maintenance and performance monitoring
                  for clean energy assets. We manage warranties, preventive care, and
                  troubleshooting to ensure your clean energy assets deliver lasting value.
                </p>
              </div>
              ...
              <div className="service-card">
                ...
                <p>
                  We support long-term management of green infrastructure including green
                  roofs, bioretention systems, and other stormwater BMPs. Our stewardship
                  services protect your investment by maintaining system longevity and
      ...
      <section id="photo-break" className="photo-break" aria-label="BESS visual">
        <div className="photo-break__sticky">
          <div className={`photo-break__overlay ${showButton ? "visible" : ""}`}>
            <button
              type="button"
              className="photo-break__button"
              onClick={openModal}
            >
              <span className="photo-break__button-header">
                Massachusetts Property Owners
              </span>
              <span className="photo-break__button-sub">
                Learn how to earn passive income through a new state battery incentive
                program
              </span>
            </button>
          </div>
      ...
      <section id="about" className="page-section about">
        <div className="about-content">
          <div className="section-text">
            <h2>ABOUT</h2>
            <p>
              Lightbox is an energy and sustainability infrastructure deployment firm. We
              specialize in distributed energy resources, energy storage, and green
              infrastructure. Our services help clients achieve sustainability and resiliency
              goals while improving facility performance and saving money.
            </p>
            <p>
              Whether you are pursuing energy compliance, passive income from your land or
              roof, backup power, or simply a healthier bottom line for your building, we
              create customized solutions to meet the project&apos;s needs.
            </p>
          </div>
          ...
          <div className="section-text">
            ...
            <div className="project-block">
              ...
              <div className="project-details">
                ...
                <ul>
                  <li>
                    On-going multi-year program providing solar PV feasibility and
                    procurement support, system design, and owner&apos;s rep services
                    during construction.
                  </li>
                  <li>
                    Nation&apos;s first roof-based clean technology program with solar PV
                    and vegetated roofs.
                  </li>
                  <li>
                    Largest on-site municipal solar procurement in US history (~12MW on 50
                    sites).
                  </li>
                  <li>
                    1M square feet and counting in new vegetated green roof installations.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="project-block">
              ...
              <div className="project-details">
                ...
                <ul>
                  <li>
                    Provided technical feasibility, financial planning, design, and
                    procurement services for school rooftop solar.
                  </li>
                  <li>
                    Portfolio currently in development with schools under construction in
                    2025.
                  </li>
                </ul>
              </div>
            ...
            <div className="project-block">
              ...
              <div className="project-details">
                <h3>
                  White House&apos;s Capital Solar Challenge, General Services Administration,
                  Washington, DC
                </h3>
                <ul>
                  <li>
                    Waterproofing and financial consulting increased solar potential by 1
                    MW.
                  </li>
                  <li>
      ...
      {/* MODAL: Request a site assessment or meeting */}
      {showModal && (
        <div className="modal-overlay" onClick={closeModal}>
          ...
          >
            ...
            <h2>Request a site assessment or intro call</h2>
            <form
